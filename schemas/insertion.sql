...
INSERT INTO public.hotel (nom, id_classe, localisation) VALUES
('Hotel de Caen', 1, 'Caen'),
('Hotel de Brest', 1, 'Brest'),
('Hotel de Paris', 2, 'Paris'),
('Hotel de Nantes', 2, 'Nantes');

INSERT INTO Conso (denomination) VALUES
('Petit déjeuner'),
('Soda'),
('Eau minérale'),
('Pression'),
...
INSERT INTO Prix_conso (id_hotel, id_conso, prix) VALUES
                                                      (1, 1, 5.99), (1, 2, 2.99), (1, 3, 1.99), (1, 4, 3.50), (1, 5, 9.99);
