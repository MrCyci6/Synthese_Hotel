							...
							<div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel">
								...
								<div class="offcanvas-body d-flex flex-column align-items-center justify-content-center p-0">
									<ul class="nav flex-column p-0 m-0">
										...
										<li class="nav-item">
											<a class="nav-link" href="#"><i class="bi bi-box-arrow-up-right"></i> Déconnexion</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="bi bi-layout-text-sidebar-reverse"></i> Tableau de Bord</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="bi bi-heart"></i> Réservations Favorites</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="bi bi-bell"></i> Notifications</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="bi bi-cash-stack"></i> Moyen de Réglements</a>
										</li>
										<li class="nav-item">
