...
<body>
    <div class="sidebar d-flex flex-column border-end">
        ...
        <div class="container border-bottom p-2">
            ...
            <select id="selectHotel" class="form-select mb-1">
