<div class="main-section flex-fill p-4 m-3 shadow-sm bg-white rounded-3">
				...
				<div class="col-12 col-md-6">
					<div class="card border-0 shadow-sm rounded-3 bg-light">
						<div class="card-body p-3">
							<h5 class="card-title fw-semibold fs-4 text-primary"><?php echo ($chambre['categorie_nom']); ?></h5>
							<p class="card-text fs-5 text-muted">
								Prix par nuit : <?php echo number_format($chambre['prix'], 2, ',', ' '); ?> €<br>
								Capacité : <?php echo $chambre['chambres_disponibles']; ?> personne(s)<br>
							...
							<form action="confirm" method="post">
								...
								<input type="hidden" name="categorie" value="<?php echo $chambre['categorie_nom']; ?>">
	...
	<a href="search" class="btn btn-outline-secondary fs-6 px-3 mt-3">Retour à la recherche</a>
</div>
