<div class="main-section flex-fill p-4 m-3 shadow-sm bg-white rounded-3">
	...
	<?php if ($reservation): ?>
		...
		<div class="d-flex gap-2 mt-3">
			<a href="reservations" class="btn btn-outline-secondary fs-6 px-3">Retour aux réservations</a>
			<a href="facture?id=<?= $reservationId ?>" class="btn btn-outline-success fs-6 px-3">Générer facture</a>
		</div>
	<?php else: ?>
